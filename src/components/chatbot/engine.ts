...
export const nodes: Record<string, (ctx: Ctx) => NodeResult> = {
 ...
 A4: (ctx) => {
  ...
  return {
   messages: [
    ...
    "And everything comes with a 30-day money-back guarantee. See results or pay nothing. ",
   ],
   options: [
 ...
 E_bye: () => ({
  messages: ["All good! Everything comes with a 30-day money-back guarantee — zero risk whenever you're ready. "],
